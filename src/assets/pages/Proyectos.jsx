...
export function Proyectos() {
  ...
  const t =
    language === "es" ? translations.proyectos : translationsEn.proyectos;
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://pablogutierrezz.com/proyectos" />
        <meta property="og:title" content={t.meta.og_title} />
        <meta property="og:description" content={t.meta.og_description} />
        <meta
          property="og:url"
          content="https://pablogutierrezz.com/proyectos"
        />
